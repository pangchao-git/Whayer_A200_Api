...
typedef enum scSAMPLE_SVP_ERR_LEVEL_E
{
...
do{\
    if ((0 != (phy)) && (0 != (vir)))\
    {\
        SC_MPI_SYS_MmzFree((phy),(void*)(SC_UL)(vir));\
        (phy) = 0;\
        (vir) = 0;\
    }\
}while(0)
...
*Align
*/
SC_U32 SAMPLE_COMM_SVP_Align(SC_U32 u32Size, SC_U16 u16Align);

/*
*Create Image memory
*/
SC_S32 SAMPLE_COMM_SVP_CreateImage(SVP_IMAGE_S *pstImg, SVP_IMAGE_TYPE_E enType, SC_U32 u32Width,
    SC_U32 u32Height, SC_U32 u32AddrOffset);
/*
*Destory image memory
*/
SC_VOID SAMPLE_COMM_SVP_DestroyImage(SVP_IMAGE_S *pstImg, SC_U32 u32AddrOffset);

/*
*Create mem info
*/
SC_S32 SAMPLE_COMM_SVP_CreateMemInfo(SVP_MEM_INFO_S *pstMemInfo, SC_U32 u32Size, SC_U32 u32AddrOffset);

/*
Destory mem info
*/
SC_VOID SAMPLE_COMM_SVP_DestroyMemInfo(SVP_MEM_INFO_S *pstMemInfo, SC_U32 u32AddrOffset);
/*
*Malloc memory
*/
SC_S32 SAMPLE_COMM_SVP_MallocMem(SC_CHAR *pszMmb, SC_CHAR *pszZone, SC_U64 *pu64PhyAddr, SC_VOID **ppvVirAddr,
    SC_U32 u32Size);
/*
*Malloc memory with cached
*/
SC_S32 SAMPLE_COMM_SVP_MallocCached(SC_CHAR *pszMmb, SC_CHAR *pszZone, SC_U64 *pu64PhyAddr, SC_VOID **ppvVirAddr,
    SC_U32 u32Size);
/*
*Fulsh cached
*/
SC_S32 SAMPLE_COMM_SVP_FlushCache(SC_U64 u64PhyAddr, SC_VOID *pvVirAddr, SC_U32 u32Size);
/*
*Gen rand data
*/
SC_S32 SAMPLE_COMM_SVP_GenRandS32(SC_S32 s32Max, SC_S32 s32Min);
/*
*Gen image
*/
SC_VOID SAMPLE_COMM_SVP_GenImage(SC_U64 au64Buff[3], SC_U32 au32Stride[3], SVP_IMAGE_TYPE_E enType, SC_U32 u32Width,
    SC_U32 u32Height);
#endif
